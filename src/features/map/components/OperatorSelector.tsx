...
const OperatorSelector: React.FC<OperatorSelectorProps> = ({ isOpen, onClose }) => {
  ...
  const modalContent = (
    ...
    <div
      className="fixed inset-0 bg-black bg-opacity-70 z-50 flex items-center justify-center p-4 transition-opacity duration-200 ease-in-out" // Use z-50 for backdrop
      onClick={onClose}
      role="dialog"
      aria-modal="true"
